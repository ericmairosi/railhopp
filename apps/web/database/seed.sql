-- Seed data for Railway Application Database
-- This file contains initial data to populate the database with realistic UK railway information
...
('ScotRail', 'ScotRail', '🏴󐁧󐁢󐁳󐁣󐁴󐁿', '#0065BD', 'https://www.scotrail.co.uk'),
