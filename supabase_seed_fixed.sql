-- Railway Application Seed Data (FIXED VERSION)
...
-- Insert routes (sample major routes) - FIXED VERSION
DO $$
DECLARE
    kgx_id UUID;
    man_id UUID;
...
BEGIN
    ...
    -- Insert routes (removed RETURNING clause that caused the error)
